...
exports.userUpdatePasswordVlidationParameters = [
...
exports.userUpdateUsernameaVlidationParameters = [
    check('username')
    .not()
    .isEmpty()
    .withMessage('Username is required')
...
exports.userUpdateEmailValidationParameters = [
    check('email')
    .isEmail()
    .withMessage('Valid email adress is required')
]
exports.userUpdateValidationParameters = [
    check('username')
    .not()
    .isEmpty()
    .withMessage('Username is required')
